...
export default function AdminDashboard() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      alert('Terjadi kesalahan atau akses ditolak.');
    }
  };
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-5">
                ...
                <div className="pt-4 border-t border-gray-100 flex justify-end gap-3">
                  ...
                  <button 
                    type="submit"
                    className="px-6 py-2.5 bg-ghania-400 text-white font-medium rounded-xl hover:bg-ghania-300 focus:ring-4 focus:ring-ghania-400/30 transition-all shadow-md"
                  >
